%%
%% nfs_rpc_xdr was generated by erpcgen (do not edit)
%% date: Aug 9 21:37:08 2014
%%
-module(nfs_rpc_xdr).
-export([enc_msg_type/1, dec_msg_type/2, dec_msg_type_i2a/1]).
-export([enc_reply_stat/1, dec_reply_stat/2, dec_reply_stat_i2a/1]).
-export([enc_accept_stat/1, dec_accept_stat/2, dec_accept_stat_i2a/1]).
-export([enc_reject_stat/1, dec_reject_stat/2, dec_reject_stat_i2a/1]).
-export([enc_auth_stat/1, dec_auth_stat/2, dec_auth_stat_i2a/1]).
-export([enc_auth_flavor/1, dec_auth_flavor/2, dec_auth_flavor_i2a/1]).
